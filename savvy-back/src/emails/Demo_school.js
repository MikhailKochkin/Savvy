                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Здравствуйте,</h1>
                        <p>
                          Это Михаил из BeSavvy. Получили вашу заявку на сайте. Я с радостью
                          проведу для вас вводное занятие и расскажу о
                          программе.
                        </p>
                        <p>
                          Но, чтобы не быть голословным, хочу сразу дать вам
                          доступ к демо-уроку нашего курса. Это урок по
                          преддоговорной ответственности из модуля "Основные
                          инструменты договорной работы корпоративного юриста".
                        </p>
                        <p>
                          Чтобы получить к нему доступ, надо зарегистрироваться
                          на сайте.
                        </p>
                        <table
                          width="100%"
                        ...
                        >
                          <tr>
                            <td align="center">
                              <a
                                href="https://besavvy.app/coursePage?id=ckqut60ya145911gqj58c0qo8a"
