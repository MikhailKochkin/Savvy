        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!argv.all) return [3 /*break*/, 5];
                    _i = 0, operationNames_1 = operationNames;
                    _b.label = 1;
                case 1:
                    if (!(_i < operationNames_1.length)) return [3 /*break*/, 4];
                    operationName = operationNames_1[_i];
                    return [4 /*yield*/, runQuery(query, operationName, endpoint)];
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3:
                ...
                case 5:
                    if (!argv.operation) return [3 /*break*/, 7];
                    return [4 /*yield*/, runQuery(query, argv.operation, endpoint)];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 12];
                case 7: return [4 /*yield*/, context.prompt({
                        type: 'checkbox',
                ...
                case 8:
                    ...
                    _b.label = 9;
                case 9:
                    if (!(_a < selectedOperationNames_1.length)) return [3 /*break*/, 12];
...
function runQuery(query, operationName, endpoint) {
    return __awaiter(this, void 0, void 0, function () {
        var response, result;
