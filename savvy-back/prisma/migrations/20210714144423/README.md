# Migration `20210714144423`

This migration has been generated by MikhailKochkin at 7/14/2021, 5:44:23 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER INDEX "CoursePage_examQuestionId_unique" RENAME TO "CoursePage.examQuestionId_unique"
```
