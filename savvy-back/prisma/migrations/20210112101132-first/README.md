# Migration `20210112101132-first`

This migration has been generated by MikhailKochkin at 1/12/2021, 1:11:33 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
DROP INDEX "_CareerTrackUnitToCoursePage_A"

DROP INDEX "_CoursePageForCareer_A"

DROP INDEX "_ExamAnswerToLegalPortfolio_A"

DROP INDEX "_PointATests_A"

DROP INDEX "_SandboxToUser_A"

DROP INDEX "_UserSubjects_A"
...
ALTER TABLE "CoursePage" DROP COLUMN "promocode",
ADD COLUMN     "promocode" JSONB

DROP TABLE "_CoursePageToCoursePage"

DROP TABLE "_RelayId"

ALTER INDEX "CoursePage_examQuestionId_key" RENAME TO "CoursePage_examQuestionId_unique"

ALTER INDEX "Lesson_forumId_key" RENAME TO "Lesson.forumId_unique"

ALTER INDEX "User_careerTrackId_key" RENAME TO "User.careerTrackId_unique"

ALTER INDEX "User_legalPortfolioId_key" RENAME TO "User.legalPortfolioId_unique"

ALTER INDEX "User_levelId_key" RENAME TO "User.levelId_unique"

ALTER INDEX "savvy-prod$prod.User.email._UNIQUE" RENAME TO "User.email_unique"

ALTER INDEX "_AuthorsCoursePage_B" RENAME TO "_AuthorsCoursePage_B_index"

ALTER INDEX "_CareerTrackUnitToCoursePage_B" RENAME TO "_CareerTrackUnitToCoursePage_B_index"

ALTER INDEX "_CoursePageForCareer_B" RENAME TO "_CoursePageForCareer_B_index"

ALTER INDEX "_ExamAnswerToLegalPortfolio_B" RENAME TO "_ExamAnswerToLegalPortfolio_B_index"

ALTER INDEX "_PointATests_B" RENAME TO "_PointATests_B_index"

ALTER INDEX "_PostCoursePages_B" RENAME TO "_PostCoursePages_B_index"

ALTER INDEX "_SandboxToUser_B" RENAME TO "_SandboxToUser_B_index"

ALTER INDEX "_UserSubjects_B" RENAME TO "_UserSubjects_B_index"
```
