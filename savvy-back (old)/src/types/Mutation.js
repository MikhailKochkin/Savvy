  ...
  definition(t) {
    ...
    t.field("sendEmailToStudent", {
      ...
      resolve: async (_, { id, reminders, comment, info }, ctx) => {
        ...
        <p>Главное, запомни, что ты занимаешься не в одиночку. Я и наши авторы всегда будем рад помочь тебе с любым учебным или техническим вопросом. </p>
        <p>С нами можно связаться, написав в наше сообщество в ТГ или ответив на это письмо.</p>
        <p><a href="https://t.me/+gmqzbUWeqlc5N2Qy" target="_blank">Вот ссылка</a> на наше сообщество.</p>
        `,
              courseVisits[0].coursePage.title,
              courseVisits[0].coursePage.id
            ),
