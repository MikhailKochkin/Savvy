...
class LandingPage extends Component {
  ...
  render() {
    const { me } = this.props;
    // console.log(me.status === "AUTHOR" || "SAVVY_AUTHOR")
    return (
      <>
        <Level1>
          <IntroText>
        ...
        <Introduction>
          <Ask>Расскажите о себе и мы настроим систему под вас</Ask>
          <Options>
            <Option active={this.state.active === 1} onClick={this.onOne}>
              {" "}
              1. Я хочу развивать свои юридические навыки онлайн{" "}
            </Option>
            <Option active={this.state.active === 2} onClick={this.onTwo}>
              {" "}
              2. Я хочу учить праву онлайн{" "}
            </Option>
            <Option active={this.state.active === 3} onClick={this.onThree}>
              {" "}
              3. Я хочу найти классную работу / талантливых сотрудников{" "}
            </Option>
          </Options>
          <Solution>
            {this.state.active === 1 && (
              <Offer>
                ...
                <Pool>
                  <p>
                    Выберите свой карьерный трек и развивайтесь с помощью
                    коротких алгоритмизированных онлайн курсов.
                  </p>
                  {!me && me === null && (
                    <Link
                      href={{
            ...
            {this.state.active === 2 && (
              <Offer>
                ...
                <Pool>
                  <p>
                    Создавайте онлайн курсы для своих студентов, используя все
                    возможности веб-технологий.
                  </p>
                  {me && me !== null && me.status === "AUTHOR" && (
                    <Link
                      href={{
                        pathname: "/educator"
                      }}
                    >
                      <a>
                        <Button>Начать преподавать!</Button>
                      </a>
                    </Link>
                  )}

                  {me && me !== null && me.status === "SAVVY_AUTHOR" && (
                    <Link
                      href={{
                        pathname: "/educator"
                      }}
