      ...
      <Container>
        ...
        <Outer id="certificate">
          <Inner>
            ...
            <div>{t("certify")}</div>
            <div className="name">
              {props.cert.student.name} {props.cert.student.surname}
            </div>
            <div>{t("completed")}</div>
            <div className="course">{props.cert.coursePage.title}</div>
            <Data>
              <div className="left">
                <div>ID: {props.cert.id}</div>
                <div>
                  {t("date")} {moment(props.cert.createdAt).format("DD.MM.YY")}
                </div>
              </div>
              <div className="right">
                <div>{t("mikhail")}</div>
