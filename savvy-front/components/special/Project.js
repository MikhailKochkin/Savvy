...
class Project extends Component {
    ...
    onHandlePromo = () => {
      if(this.state.promo !== ""){
        if (this.state.promo.toUpperCase() === "SAVVYGRAM" 
          ...
          } else if (this.state.promo.toUpperCase() === "SAVVYEARLYBIRD"
          && (this.state.tarif === "Стандарт" || this.state.tarif === "Премиум")
          && !this.state.promoUsed) {
            this.setState(prevState => ({
            ...
            alert("Не получилось. Возможно, на этот тариф промокод не действует. Или такого промокода нет. Или вы уже использовали другой промокод.")
          }
        }  
    }
        ...
        return (
            <User>
              ...
              <CaseCard>
                ...
                <Level1>
                    <Video>
                        <Iframe width="620" height="400" src={"https://www.youtube.com/embed/IBkes96vRic"} allowFullScreen/>
                    </Video>
                    <Box>
                      <div>
                ...
                <Tarif>
                    <Choose>
                        <ul>
                        <p>Выберите наиболее удобные для вас параметры прохождения курса:</p>
                    ...
                    <Info>
                        ...
                        <Card>
                            ...
                            <MainText>
                                {program}
                                <p>✅ Чат участников</p>
                                <p>✅ Дополнительные юридические задания в гугл-документе</p>
                            </MainText>
                        </Card>
                        }
                ...
                <Center>
                    <Price>
                        <p>Введите промокод, чтобы получить скидку, и переходите к оплате! </p>

                        <PriceBox>Сейчас стоимость курса составляет {this.state.price} рублей.</PriceBox>
                        <input
                            spellcheck={true}
                            name={"promo"}
                ...
                <Buy>
                    <Terms>
                        <PriceBox>
                            <p>Вы можете использовать промокоды для покупки сразу двух месяцев программы.
                                Такая покупка является наиболее выгодной.</p>
                            
                            <select name="months" value={this.state.months} onChange={this.handlePrice}>
                    ...
                    <Click>
                        ...
                        <Author>После оплаты вы получите на почту письмо с подтверждением и описанием дальнейших действий.</Author>
                    </Click>
