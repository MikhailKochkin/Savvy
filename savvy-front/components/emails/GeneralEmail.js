...
const GeneralEmail = (props) => {
  const [trigger, setTrigger] = useState(
    // `<p>Hello ${props.name},</p><p><b>I am writing to ask you for advice</b> since I have heard very positive reviews about training programs at ${props.firm}.</p><p>I am Michael, the founder of BeSavvy where we help law firms upskill trainees with GenAI-powered transaction simulators. <u>Simulators can save associates' time and help trainees get to billing work faster.</u></p><p>I understand that you are busy and already have established training programs and operations at ${props.firm}. That's why I am not trying to sell anything at the moment.</p><p><b>All I want is to ask you for advice.</b>I want to make sure that we are building something the market needs and may use one day. <p><b>So would you be open to reviewing a brief deck (9 slides)</b> that outlines how our transaction simulators function and sharing your thoughts on whether you can envision using them in the future?</p><p>It would mean a world to us to get feedback from a market leader like you.  And I am sure that you will find it useful to learn about a completely new approach to training lawyers.</p><p>Best regards,</p>`
    ...
    `<p>Hello ${props.name},</p><p>I have written you last week about the new way to develop trainees – with GenAI-powered transaction simulators. <u>Simulators can save associates' time and help trainees get to billing work faster</u>.</p><p>That's why we are building BeSavvy, a platform where developing simulators is easy and fast.</p><p>I understand that you are busy and already have established training programs and operations at ${props.firm}. That's why I am not trying to sell anything at the moment.</p><p>All I want is <b>to ask you for advice</b>. I want to make sure that we are building something the market needs and may use one day.</p><p><b>So would you be open to reviewing a brief deck (9 slides)</b> that outlines how our transaction simulators function and sharing your thoughts on whether you can envision using them in the future?</p><p>It would mean a world to us to get feedback from a market leader like you. And I am sure that you will find it useful to learn about a completely new approach to training lawyers.</p><p>Best regards,</p>`
  );
