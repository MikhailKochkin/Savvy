...
const GeneralEmail = (props) => {
  const [trigger, setTrigger] = useState(
    `<p>${props.name}, добрый день,</p><p>Направляем запись онлайн встречи "Карьера IT юриста в 2024 году".</p><p>Вот <a href="https://youtu.be/fhd_21VERoo" target="_blank">ссылка</a>.</p><p>Также присоединяйтесь к нашему <b>курсу "IT юрист"</b> сегодня со <b>скидкой -24%</b>. Можно взять в рассрочку. Смотрите программу и оставляйте заявку <a href="https://besavvy.app/ru/program?id=clomjz83x0000xsl3kupzpxwb&form=lead" target="_blank">по этой ссылке</a>.</p>`
  ...
  const [subject, setSubject] = useState(
    props.subject ? props.subject : "Запись: Онлайн-встреча IT юристов 2024"
  );
