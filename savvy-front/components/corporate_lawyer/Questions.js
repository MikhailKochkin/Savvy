...
const Questions = () => {
  let questions = [
    ...
    {
      question:
        "Что вы мне рассказываете, за 4 месяца невозможно выучить так много!",
      answer:
    ...
    {
      question: "Как получить скидку на программу?",
      answer:
        "Для этого надо пройти небольшое испытание. Его задача – оценить ваше аналитическое, креативное и структруное мышление. Мы проверим и вернемся к вам с результатами.",
    },
    {
