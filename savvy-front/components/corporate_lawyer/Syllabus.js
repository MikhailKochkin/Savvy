...
const Syllabus = () => {
  let modules = [
    ...
    {
      number: "Модуль 2",
      name: "Финансирование корпорации",
      case: "Организация компании",
      lessons: ["Тема 1", "Тема 2", "Тема 3"],
    },
    {
      number: "Модуль 3",
      name: "Корпоративное управление, или как избежать дедлоки",
      case: "Организация компании",
      lessons: ["Тема 1", "Тема 2", "Тема 3"],
    },
    {
    ...
    {
      number: "Модуль 5",
      name: "Обеспечение обязательств в корпоративных сделках",
      case: "Организация компании",
      lessons: ["Тема 1", "Тема 2", "Тема 3"],
    },
    {
    ...
    {
      number: "Модуль 7",
      name: "Соглашения об осуществлении прав участников (SHA)",
