...
const Syllabus = () => {
  let modules = [
    ...
    {
      number: "Модуль 4",
      name: "Способы защиты прав компании с помощью инструментов IP ",
      case: "Организация компании",
      lessons: [
        ...
        "Особенности судебных споров области интеллектуальной собственности",
      ],
    },
    {
      number: "Модуль 5",
      name: "Вопросы Digital law в работе компании",
      case: "Организация компании",
      lessons: [
    ...
    },
    {
      ...
      case: "Организация компании",
      lessons: [
        "Основные положения о банкротстве, принципы и критерии банкротства",
        "Арбитражные управляющие",
        "Возбуждение дела о банкротстве и процедуры банкротства",
        "Стратегия ведения банкротного дела в суде?",
      ],
    },
    {
      number: "Модуль 8",
