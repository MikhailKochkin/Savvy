...
const Syllabus = () => {
  let modules = [
    ...
    },
    {
      ...
      case: "Организация компании",
      lessons: [
        "Как определить компетентный суд для рассмотрения спора",
        "Участники процесса и особенности представительства в арбитражных судах",
        "Когда и как необходимо соблюдать досудебный порядок урегулирования спора",
        "Практические рекомендации по доказыванию, судебная экспертиза",
        "Обеспечительные меры арбитражных судов",
        "Производство в арбитражном суде первой инстанции: от составления искового заявления до вынесения решения суда",
        "Взыскание судебных расходов",
        "Пересмотр судебных актов: апелляция, кассация, надзор, производство по новым и вновь открывшимся обстоятельствам",
      ],
    },
    {
      number: "Модуль 8",
