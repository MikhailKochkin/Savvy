      ...
      <Text>
        <div>
          <div className="header">
            Что вам не хватает для успешной карьеры юриста?{" "}
          </div>
          <p>Дело не в знаниях. </p>
          <p>Вам нужно:</p>
          <ul>
            <li>
            ...
            <li>
              получить систему практикоориентированных онлайн-курсов, которые вы
              можете пройти в своем темпе, готовясь к собеседованию или участвуя
              в проекте
            </li>
            <li>
