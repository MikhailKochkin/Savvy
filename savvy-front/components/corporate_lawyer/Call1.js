          ...
          <Block>
            <div id="block1">
              <div>
                ...
                <span style={{ color: "#FF6F59" }}>карьерную консультацию</span>{" "}
                с директором программы.{" "}
              </div>
              <div id="additional-info">
                Мы разберемся в ваших целях и нынешних знаниях, расскажем о
                программе, о наших преподавателях и подходах, о рынке.
              </div>
            </div>
            <div id="block2">
              <div id="form">
