        ...
        <Variants>
          ...
          {task === "note" && (
            <Section>
              {notes.map((n) => (
                <div className="option">
                  <div>{parse(n.text.substring(0, 100))}</div>
                  <button
                    name={n.__typename}
                    value={n.id}
                    onClick={(e) =>
          ...
          {task === "texteditor" && (
            <Section>
              {texteditors.map((s) => (
                <div className="option">
                  <div>{parse(s.text.substring(0, 100))}</div>
                  <button
                    name={s.__typename}
                    value={s.id}
                    onClick={(e) =>
          ...
          {task === "problem" && (
            <Section>
              ...
              {problems.map((s) => (
                <div className="option">
                  <div>{parse(s.text.substring(0, 300))}</div>
                  <button
                    name={s.__typename}
                    value={s.id}
                    onClick={(e) =>
          ...
          {task === "forum" && (
            <Section>
              <div>{parse(forum.text.substring(0, 100))}</div>
              <button
