...
const UPDATE_LESSON_MUTATION = gql`
  mutation UPDATE_LESSON_MUTATION($id: ID!, $number: Int, $name: String, $text: String) {
        ...
        return (
          ...
          >
            ...
            <Width>
              ...
              <DynamicLoadedEditor getEditorText={this.myCallback} previousText={data.lesson.text}/>
