...
const TopBar = styled.div`
  ...
  h1 {
    ...
    margin-bottom: 20px;
    span {
      border-bottom: 3px solid #cc1026;
    }
  }
  h3 {
    font-size: 2rem;
...
const Subscription = (props) => {
  ...
  const makeInternationalPayment = async (price) => {
    if (!props.me) {
      ...
      if (price === 1990) {
        location.href = "https://buy.stripe.com/4gw1755Iy1iO1kQfYY";
      } else {
        location.href = "https://buy.stripe.com/8wMbLJfj8gdI2oU6op";
      }
    }
  };

  let one_month_mini_price = 1990;
  if (props.type === "gift") {
    one_month_mini_price = 1;
  } else if (props.type === "special") {
    one_month_mini_price = 990;
  }
          ...
          {plan === "monthly" ? (
            <>
              <Form>
                ...
                <ButtonBuy
                  onClick={(e) => completePayment(one_month_mini_price)}
                >
                  {loading_data ? "..." : "Подписаться (RU карта)"}
                </ButtonBuy>
                <ButtonBuy
                  onClick={(e) =>
                    makeInternationalPayment(one_month_mini_price)
                  }
                >
              ...
              <Form>
                ...
                <ButtonBuy onClick={(e) => completePayment(3990)}>
                  {loading_data ? "..." : "Подписаться (RU карта)"}
                </ButtonBuy>
              ...
              <Form>
                ...
                <ButtonBuy onClick={(e) => makeInternationalPayment(8990)}>
                  Подписаться (Intl карта)
                </ButtonBuy>
              </Form>
            </>
            ...
            <>
              <Form>
                ...
                <div className="section">
                  <div className="comment">Стоимость</div>
                  <div className="label" for="mistakes">
                    <span>23 990</span> 13 990 ₽ / 6 месяцев
                  </div>
                </div>
                <div className="section">
                  <div className="comment">
              ...
              <Form>
                ...
                <div className="section">
                  <div className="comment">Стоимость</div>
                  <div className="label" for="mistakes">
                    <span>53 940</span> 35 990 ₽ / 6 месяцев
                  </div>
                </div>
                <div className="section">
                  <div className="comment">
