...
const Program = (props) => {
  ...
  const programs = [
    {
      header: `Изучите все тонкости работы <span>корпоративного юриста</span>`,
      subheader:
        "Мы на практических кейсах научим вас структурировать сделки, анализировать корпоративные документы и строить карьеру.",
      image:
