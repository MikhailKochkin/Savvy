        ...
        switch(this.state.page) {
            ...
            this.pageView = (
                <>
                    ...
                    <Tip>
                        <P>
                        Мы хотим решить проблему курсов, добавив в них как можно больше возможностей для тестирования своих знаний и оттаивания навыков.
            ...
            this.pageView = (
                <>
                  <h1>Что такое песочницы и как ими пользоваться?</h1>
                    <P>
                    Песочницы  - это разделы, в которых юристы смогут совместно разрабатывать различные правовые вопросы. 
                    Каждый сможет кратко описать то, что он уже знает из книг или практической работы. 
                    Модератор сможет объединять ответы, фильтровать их, в результате получится актуальная на сегодняшний день подборка информации по насущным вопросам. 
                    Создать песочницу может каждый. Для этого вам нужно определить актуальную проблему. 
                    Например, признание и исполнение иностранных арбитражных решений российскими судами. 
                    ...
                    Или “Вопросы к экзамену по гражданскому праву в МГУ”. В результате вместо того, чтобы самим решать эти вопросы, 
                    подключите все сообщество студентов и юристов к разработке актуальной проблемы. 
                    </P>
