...
const UNI_COURSE_PAGES_QUERY = gql`
  query UNI_COURSE_PAGES_QUERY($type: [ CourseType! ], $boolean: Boolean = true, $skip: Int = 0, $first: Int = ${CoursePerPage}) {
...
const AGGREGATE_UNI_COURSE_PAGES_QUERY = gql`
  query AGGREGATE_UNI_COURSE_PAGES_QUERY($type: [CourseType!]) {
