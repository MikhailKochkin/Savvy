  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Message>
          Первые курсы университетов уже совсем скоро! 😁 <br />
          Если хотите разместить на нашей платформе курсы своего университета
          или сообщества,{" "}
          <a href="mailto:mi.kochkin@ya.ru?cc=valvin2000@ya.ru&subject=Сотрудничество">
            пишите.{" "}
          </a>
        </Message>
