  ...
  return (
    <>
      <Block>
        ...
        <Text>
          <div className="header">Практические навыки младших юристов</div>
          <div>
            Даже получив первую работу, необходимо продолжать развивать свои
            практические навыки, чтобы быть готовым к сложным и интересным
            проектам.
          </div>
