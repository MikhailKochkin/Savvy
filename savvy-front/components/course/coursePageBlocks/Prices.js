      ...
      <Container>
        ...
        <PriceBoxContainer>
          <PriceBox>
            ...
            <p className="description">{renderHTML(p[0].description)}</p>
          ...
          <Box>
            ...
            <PriceBoxBlue>
              ...
              <p className="description">{renderHTML(p[1].description)}</p>
          ...
          <PriceBox>
            ...
            <p className="description">{renderHTML(p[2].description)}</p>
