...
const NewCoursePage = (props) => {
  ...
  const programs = [
    ...
    },
    {
      ...
      offer: `Начните учиться сегодня со скидкой 10%`,
      price: {
        price: 13900,
        full: "13 900₽",
        full_explain: "Полная стоимость",
...
`,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Нет, курс состоит из 2 частей. Первая – это теоретические материалы и различные задания. Вы их проходите на сайте в любое удобное время. Вторая – живые практические занятия с авторами курсов в Zoom. Занятия записываются.",
        },
        {
          q: "Какой формат занятий?",
          a: "Вы в своем темпе проходите онлайн-уроки на платформе besavvy.app в течение недели, задаете вопросы преподавателю в чате, учавствуете в разборе сложных кейсов с преподавателем в зуме.",
    ...
    },
    {
      ...
      offer: `Оставьте заявку – получите обзор практики интересных кейсов про недействительные браки`,
      price: {
        price: 17900,
        full: "17 900₽",
        full_explain: "Полная стоимость",
